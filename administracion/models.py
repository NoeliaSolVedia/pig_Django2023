...
class Turista(Persona):
    ...
    atractivo = models.IntegerField(choices=ATRACTIVOS,default=1)
    aceptar = models.BooleanField(default=0)
    consulta = models.ForeignKey(Consulta,on_delete=models.CASCADE) #relacion mucho a uno    
...
class Atractivo(models.Model):
    ...
    guia = models.ManyToManyField(Guia) #relacion mucho a muchos
